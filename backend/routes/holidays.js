...
router.get('/', protect, async (req, res) => {
  try {
    ...
    const formatted = holidays.map(holiday => ({
      ...
      created_by: holiday.createdBy_populated ? {
        id: holiday.createdBy_populated.id,
        name: holiday.createdBy_populated.fullName || holiday.createdBy_populated.username
      } : null,
...
router.delete('/:id', protect, authorize('ceo', 'super_admin'), async (req, res) => {
  try {
    ...
    await Holiday.findByIdAndDelete(holiday.id);
