...
async function sendPushNotification(userId, title, body, data = {}) {
  try {
    ...
    // Note: User.findById doesn't support select, so we'll just use the full user object
    // The fields we need (expoPushToken, pushNotificationsEnabled, fullName) are already in the user object
