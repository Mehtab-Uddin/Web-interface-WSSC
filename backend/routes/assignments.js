...
router.get('/', protect, async (req, res) => {
  try {
    ...
    const formatted = assignments.map(ass => ({
      ...
      emp_no: ass.staffId_populated ? (ass.staffId_populated.empNo || null) : null,
      empNo: ass.staffId_populated ? (ass.staffId_populated.empNo || null) : null,
  ...
  try {
    ...
    res.status(201).json({
      ...
      data: {
        ...
        emp_no: populated.staffId_populated ? (populated.staffId_populated.empNo || null) : null,
        empNo: populated.staffId_populated ? (populated.staffId_populated.empNo || null) : null,
